<template>
    ...
    <div
        :style="{ gridArea: getGridArea(hasLabel ? 1 : 0), justifySelf: align }"
        class="widget"
    >
        <slot></slot>
    </div>
...
const getGridArea = (n: number) =>
    `${rowData[n][0]} / ${colData[n][0]} / ${rowData[n][1]} / ${colData[n][1]}`;
